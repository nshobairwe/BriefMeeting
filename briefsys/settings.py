"""
Django settings for briefsys project.
...
SECRET_KEY = 'django-insecure-faxnc#2q@=8slfb8g-lln^b@%bb)v*a*)0+62l@+8of75-m5wo'
...
WSGI_APPLICATION = 'briefsys.wsgi.application'
